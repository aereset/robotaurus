 ...
 *
 */
void sfcn_PWM_Out3_Outputs_wrapper(const uint8_T *motor2,
			const real_T *xD,
			const uint8_T  *pin2, const int_T  p_width0)
{
...
/*
  ...
  *
  */
void sfcn_PWM_Out3_Update_wrapper(const uint8_T *motor2,
			real_T *xD,
			const uint8_T  *pin2,  const int_T  p_width0)
{
