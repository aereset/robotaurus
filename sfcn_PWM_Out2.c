 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Feb 15 01:16:31 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_PWM_Out2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_PWM_Out2_Outputs_wrapper(const uint8_T *motor1,
			const uint8_T *motor2,
			const real_T *xD,
			const uint8_T  *pin, const int_T  p_width0);
extern void sfcn_PWM_Out2_Update_wrapper(const uint8_T *motor1,
			const uint8_T *motor2,
			real_T *xD,
			const uint8_T  *pin,  const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfcn_PWM_Out2_Outputs_wrapper(motor1, motor2, xD, pin, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_PWM_Out2_Update_wrapper(motor1, motor2,  xD, pin, p_width0);
}
